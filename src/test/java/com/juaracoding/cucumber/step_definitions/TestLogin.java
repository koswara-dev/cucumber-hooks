...
public class TestLogin {
    ...
    public void user_invalid_credentials() {
        Assert.assertEquals(loginPage.msgInvalid(), "Invalid credentials");
    ...
    public void user_valid_credentials() {
        Assert.assertEquals(loginPage.getTxtEmpInfo(), "Employee Information");
        Assert.assertTrue(loginPage.getTxtEmpInfo().contains("Employee"));
